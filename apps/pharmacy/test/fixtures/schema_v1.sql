...
CREATE TABLE "products" ("id" TEXT NOT NULL, "trade_name" TEXT NOT NULL, "arabic_name" TEXT NULL, "active_ingredient" TEXT NOT NULL, "strength" TEXT NULL, "form" TEXT NULL, "manufacturer" TEXT NULL, "shelf" TEXT NULL, "price_minor" INTEGER NOT NULL, "prescription_only" INTEGER NOT NULL DEFAULT 0 CHECK ("prescription_only" IN (0, 1)), "low_stock_threshold" INTEGER NOT NULL DEFAULT 5, "active" INTEGER NOT NULL DEFAULT 1 CHECK ("active" IN (0, 1)), "created_at" TEXT NOT NULL, "updated_at" TEXT NOT NULL, "updated_by_device" TEXT NOT NULL, PRIMARY KEY ("id"));
CREATE TABLE "sale_lines" ("id" TEXT NOT NULL, "sale_id" TEXT NOT NULL REFERENCES sales (id), "product_id" TEXT NOT NULL, "quantity" INTEGER NOT NULL, "unit_price_minor" INTEGER NOT NULL, PRIMARY KEY ("id"));
